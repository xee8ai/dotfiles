...
class GitignoreTemplatesPopulator:
    ...
    def _set_environment(self):
        ...
        if self.platform == "linux":
            ...
            self.gitignore_templates_dir = os.path.join(
                self.home_dir, ".gitignore_templates"
            )
            print(
                "gitignore_templates dir is {}: ".format(self.gitignore_templates_dir)
            )
    ...
    def _install_templates(self, name, source):
        ...
        subprocess.call(
            ["git", "clone", source, os.path.join(self.gitignore_templates_dir, name)]
        )
